...
use App\Charts\BookingsByFaciltyChart;
...
class AuthController extends Controller
{
     ...
     * @return response()
     */
    public function dashboard(BookingsByFaciltyChart $chart)
    {
        if(Auth::check()){
            $cUser = User::count();
            $booking = BookingFacility::all();
            $cBooking = $booking->count();


            $facility = Facility::all();
            // dd($cat);

            return view('dashboard', compact('cUser', 'cBooking'), ['chart' => $chart->build()]);
        }
